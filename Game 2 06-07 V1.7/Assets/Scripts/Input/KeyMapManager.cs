...
class KeyMapManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Map().AddKey("Sprint", KeyCode.LeftShift, InputType.Button);
    ...
    /// <summary>
    /// Fetches the virtual button data
    /// </summary>
    /// <param name="_name">The name of the virtual button</param>
    /// <returns>The specified virtual button</returns>
    public VirtualButton GetVirtual(string _name)
    {
